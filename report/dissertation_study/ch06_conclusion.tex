...
\paragraph{Common noise via deep signatures.}  Hu, Jin, and Lauri\`ere \cite{hu2025} have recently proposed using the \emph{signature} of the common-noise path $(W^S_s)_{s \leq t}$ as a conditioning feature in deep BSDE solvers. This would allow the CX model extension with common noise to be addressed directly. The repo's exploratory scripts in this direction should be extended.
